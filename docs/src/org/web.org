...
* Registering Handlers
  ...
  To register a Ring handler, you simply call the [[./apidoc/immutant.web.html#immutant.web/start][immutant.web/start]], which
...
* Deregistering Handlers
  ...
  You can deregister a Ring handler via the [[./apidoc/immutant.web.html#immutant.web/stop][immutant.web/stop]] function,
...
* Sessions
  ...
  [[./apidoc/immutant.web.session.html#immutant.web.session/servlet-store][immutant.web.session/servlet-store]], and use it by passing it as the =:store=
...
* Serving static resources
  ...
  [[./apidoc/immutant.web.html#immutant.web/wrap-resource][immutant.web/wrap-resource]], which is a drop-in replacement for
