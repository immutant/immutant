...
* Starting a Daemon
  ...
  The primary abstraction is the [[./apidoc/immutant.daemons.html#var-Daemon][immutant.daemons/Daemon]] protocol,
  which prescribes two methods: [[./apidoc/immutant.daemons.html#var-start][start]] and [[./apidoc/immutant.daemons.html#var-stop][stop]]. Daemon instances are
  passed to the [[./apidoc/immutant.daemons.html#var-create][immutant.daemons/create]] function along with a name. A
  ...
  A convenience function, [[./apidoc/immutant.daemons.html#var-daemonize][immutant.daemons/daemonize]], may be used to
