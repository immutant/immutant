...
** Creating
   ...
   releasing at commit/rollback. See [[http://infinispan.org/docs/6.0.x/user_guide/user_guide.html#_configuring_transactions][the Infinispan docs]] for more
   details.
...
** Advanced Infinispan Configuration
   ...
   Infinispan's "fluent API" is invoked via a [[http://docs.jboss.org/infinispan/6.0/apidocs/index.html?org/infinispan/configuration/cache/ConfigurationBuilder.html][ConfigurationBuilder]] as
   described in their docs for [[http://infinispan.org/docs/6.0.x/user_guide/user_guide.html#_configuring_cache_programmatically][configuring a cache programmatically]]. A
   ...
   return an Infinispan [[http://docs.jboss.org/infinispan/6.0/apidocs/index.html?org/infinispan/configuration/cache/Configuration.html][Configuration]] instance you can then pass to
