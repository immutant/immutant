...
* Scheduling Jobs
  ...
  Scheduling a job is as simple as calling [[./apidoc/immutant.jobs.html#immutant.jobs/schedule][immutant.jobs/schedule]]:
...
* Unscheduling Jobs
  ...
  Jobs can be unscheduled via the [[./apidoc/immutant.jobs.html#immutant.jobs/unschedule][immutant.jobs/unschedule]] function:
