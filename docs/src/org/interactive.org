...
*** Starting Swank Programatically
    ...
    call [[./apidoc/immutant.repl.html#immutant.repl/start-swank][immutant.repl/start-swank]]:
...
** Shutting Down Swank
   ...
   can do so using the [[./apidoc/immutant.repl.html#immutant.repl/stop-swank][immutant.repl/stop-swank]] function:
...
*** Starting nREPL Programatically
    ...
    if you need to start it in response to a runtime event or bind to an
    interface other than the [[#interactive-binding][management interface]]. To do so, simply
    call [[./apidoc/immutant.repl.html#immutant.repl/start-nrepl][immutant.repl/start-nrepl]]. nREPL allows you to have multiple
...
** Shutting Down nREPL
   ...
   application is undeployed, but if you need to do so before undeploy you
   can do so using the [[./apidoc/immutant.repl.html#immutant.repl/stop-nrepl][immutant.repl/stop-nrepl]] function. You'll need to
...
* Reloading application dependencies
  ...
  - [[./apidoc/immutant.dev.html#immutant.dev/reload-project!][immutant.dev/reload-project!]] Resets the application's class loader to provide the
  ...
  - [[./apidoc/immutant.dev.html#immutant.dev/add-dependencies!][immutant.dev/add-dependencies!]] Adds the given dependencies into the currently active 
    ...
    Returns the project map.
  - [[./apidoc/immutant.dev.html#immutant.dev/current-project][immutant.dev/current-project]] Returns the map representing the currently active 
