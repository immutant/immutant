...
** Arbitrary Configuration Values
   ...
   to your application by passing the =:config= key to [[./apidoc/immutant.registry.html#immutant.registry/get][immutant.registry/get]]:
   ...
   from [[./apidoc/immutant.registry.html#immutant.registry/get][immutant.registry/get]] under the =:project= key:
