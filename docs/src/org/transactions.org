...
** Transaction Scope
   ...
   So instead, [[./apidoc/immutant.xa.html#var-/docs.oracle.com/javaee/6/tutorial/doc/bncij.html][the JEE transaction attributes]] in the form of Clojure macros. In fact, the
