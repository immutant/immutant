...
public class XaDependenciesProcessor implements DeploymentUnitProcessor {
    
    private static ModuleIdentifier IMMUTANT_XA_ID = ModuleIdentifier.create("org.immutant.xa");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (unit.hasAttachment( ClojureMetaData.ATTACHMENT_KEY )) {
            addDependency( moduleSpecification, moduleLoader, IMMUTANT_XA_ID );
        }
    }
