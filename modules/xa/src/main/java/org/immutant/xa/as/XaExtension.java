...
public class XaExtension extends AbstractBootstrappableExtension {
    ...
    public void initialize(ExtensionContext context) {
        bootstrap();
        log.debug( "Initializing Immutant XA Subsystem" );
        final SubsystemRegistration registration = context.registerSubsystem( SUBSYSTEM_NAME, 1, 0 );
        final ManagementResourceRegistration subsystem = registration.registerSubsystemModel( XaSubsystemProviders.SUBSYSTEM );
    ...
    public void initializeParsers(ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.CURRENT.getUriString(), XaSubsystemParser.getInstance());
    }

    public static final String SUBSYSTEM_NAME = "immutant-xa";
    static final Logger log = Logger.getLogger( "org.immutant.xa.as" );
