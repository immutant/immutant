...
class BuildInfo
  ...
  def determine_immutant_versions
  ...
  def dump_versions
    path = File.dirname( __FILE__ ) + '/../target/classes/org/immutant/immutant.properties'
  ...
  def from_polyglot_properties(name)
    unless @polyglot_props
      ...
      puts Dir.chdir(File.join( m2_repo, "org/projectodd/polyglot-core/") ) {Dir["*/**/**"]}
