...
public class JobsExtension extends AbstractBootstrappableExtension {
    ...
    public void initialize(ExtensionContext context) {
        bootstrap();
        log.debug( "Initializing Immutant Jobs Subsystem" );
    ...
    public void initializeParsers(ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.CURRENT.getUriString(), JobsSubsystemParser.getInstance());
    }

    public static final String SUBSYSTEM_NAME = "immutant-jobs";
    static final Logger log = Logger.getLogger( "org.immutant.jobs.as" );
