...
public class BootstrapExtension implements Extension {
    ...
    public void initialize(ExtensionContext context) {
        log.info( "Initializing Immutant App Bootstrap Subsystem" );
    ...
    public static final String SUBSYSTEM_NAME = "immutant-bootstrap";
    static final Logger log = Logger.getLogger( "org.immutant.bootstrap.as" );
