...
public class DaemonsDependenciesProcessor implements DeploymentUnitProcessor {
    
    private static ModuleIdentifier IMMUTANT_DAEMONS_ID = ModuleIdentifier.create("org.immutant.daemons");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (unit.hasAttachment( ClojureMetaData.ATTACHMENT_KEY )) {
            addDependency( moduleSpecification, moduleLoader, IMMUTANT_DAEMONS_ID );
        }
    }
